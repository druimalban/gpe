...
\textbf{Tecnolog{\'\i}a}
\begin{compactitem}
   \item Sistema X Window {\texttrademark}{}: XFree86~4.3/tinyX con las extensiones
     Render y Redimensionar/Rotar
   \item fontconfig
   ...
   \item Paquetes disponibles para Familiar Linux. Soporte para OpenZaurus
     en camino.
\end{compactitem}

\smallskip
\textit{{\textexclamdown}Usarios y desarrolladores son bienvenidos!}\hfill\tiny{\$Revision$}
}
