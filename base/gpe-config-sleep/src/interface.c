...
GtkWidget*
create_GPE_ISgui (ipaq_conf_t *ISconf)
{
  GtkWidget *GPE_ISgui;
  GtkWidget *table1;
  GtkWidget *sleep;
  ...
  GPE_ISgui = gtk_window_new (GTK_WINDOW_TOPLEVEL);
  gtk_widget_set_name (GPE_ISgui, "GPE_ISgui");
  gtk_object_set_data (GTK_OBJECT (GPE_ISgui), "GPE_ISgui", GPE_ISgui);
  gtk_window_set_title (GTK_WINDOW (GPE_ISgui), "GPE-ISgui");
  gtk_window_set_policy (GTK_WINDOW (GPE_ISgui), TRUE, TRUE, TRUE);

  table1 = gtk_table_new (3, 2, FALSE);
  gtk_widget_set_name (table1, "table1");
  gtk_widget_ref (table1);
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "table1", table1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table1);
  gtk_container_add (GTK_CONTAINER (GPE_ISgui), table1);

  sleep = gtk_frame_new ("Auto-sleep");
  gtk_widget_set_name (sleep, "sleep");
  gtk_widget_ref (sleep);
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep", sleep,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "table2", table2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_idle_spin", sleep_idle_spin,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_idle_label", sleep_idle_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_enable", sleep_enable,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_widget_ref (dim);
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "dim", dim,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (dim);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "table3", table3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "dim_spin", dim_spin,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "dim_idle_label", dim_idle_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "dim_enable", dim_enable,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "frame5", frame5,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "table4", table4,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_cpu", sleep_cpu,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_cpu_spin", sleep_cpu_spin,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_cpu_label", sleep_cpu_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_choose_irq", sleep_choose_irq,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_apm", sleep_apm,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "sleep_probe_irq", sleep_probe_irq,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "frame6", frame6,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "vbox2", vbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "dim_scale", dim_scale,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "hbuttonbox1", hbuttonbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "start_but", start_but,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "stop_but", stop_but,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (GPE_ISgui), "quit_but", quit_but,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_signal_connect (GTK_OBJECT (GPE_ISgui), "delete_event",
  ...
  gtk_object_set_data (GTK_OBJECT (GPE_ISgui), "tooltips", tooltips);
