...
create_GPE_Config_Sleep (ipaq_conf_t *ISconf)
{
  ...
  gtk_table_attach (GTK_TABLE (table1), sleep, 0, 4, 0, 1,
  ...
  gtk_signal_connect (GTK_OBJECT (sleep_idle_spin), "format-value",
                      ...
                      NULL);
	//gtk_spin_button_new (GTK_ADJUSTMENT (sleep_idle_spin_adj), 1, 0);
  gtk_widget_show (sleep_idle_spin);
  
  gtk_table_attach (GTK_TABLE (table1), sleep_idle_spin, 2, 4, 1, 2,
  ...
  gtk_table_attach (GTK_TABLE (table1), dim, 0, 4, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  ...
  gtk_signal_connect (GTK_OBJECT (dim_spin), "format-value",
                      GTK_SIGNAL_FUNC (change_scale_label),
                      NULL);
  	//gtk_spin_button_new (GTK_ADJUSTMENT (dim_spin_adj), 1, 0);
  gtk_widget_show (dim_spin);
  gtk_table_attach (GTK_TABLE (table1), dim_spin, 2, 4, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, gpe_box_spacing);
  ...
  gtk_table_attach (GTK_TABLE (table1), frame5, 0, 4, 6, 7,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, gpe_box_spacing);
  ...
  gtk_table_attach (GTK_TABLE (table1), sleep_cpu_spin, 1, 3, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0.99, 0.0);
  ...
  gtk_table_attach (GTK_TABLE (table1), sleep_cpu_label, 3, 4, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), gpe_box_spacing, 0);
