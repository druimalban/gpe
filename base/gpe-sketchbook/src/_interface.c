...
create_window_about (void)
{
  ...
  GtkWidget *vbox3;
  GtkWidget *frame1;
  GtkWidget *label_about_text;
  GtkWidget *button_about_ok;
  ...
  gtk_object_set_data_full (GTK_OBJECT (window_about), "vbox3", vbox3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (window_about), "frame1", frame1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame1);
  gtk_box_pack_start (GTK_BOX (vbox3), frame1, TRUE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame1), 5);

  label_about_text = gtk_label_new ("about...");
  gtk_widget_ref (label_about_text);
  gtk_object_set_data_full (GTK_OBJECT (window_about), "label_about_text", label_about_text,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label_about_text);
  gtk_container_add (GTK_CONTAINER (frame1), label_about_text);
  gtk_misc_set_padding (GTK_MISC (label_about_text), 20, 20);

  button_about_ok = gtk_button_new_with_label ("OK");
  gtk_widget_ref (button_about_ok);
  gtk_object_set_data_full (GTK_OBJECT (window_about), "button_about_ok", button_about_ok,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button_about_ok);
  gtk_box_pack_start (GTK_BOX (vbox3), button_about_ok, FALSE, FALSE, 0);

  gtk_signal_connect (GTK_OBJECT (window_about), "delete_event",
                      GTK_SIGNAL_FUNC (gtk_widget_hide),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (button_about_ok), "clicked",
                      GTK_SIGNAL_FUNC (on_button_about_ok_clicked),
                      NULL);
...
GtkWidget*
create_window_dialog (void)
{
  GtkWidget *window_dialog;
  GtkWidget *vbox4;
  GtkWidget *frame3;
  GtkWidget *label_dialog_text;
  GtkWidget *hbox1;
  GtkWidget *button_dialog_cancel;
  GtkWidget *button_dialog_ok;

  window_dialog = gtk_window_new (GTK_WINDOW_DIALOG);
  gtk_object_set_data (GTK_OBJECT (window_dialog), "window_dialog", window_dialog);
  gtk_window_set_position (GTK_WINDOW (window_dialog), GTK_WIN_POS_CENTER);
  gtk_window_set_modal (GTK_WINDOW (window_dialog), TRUE);

  vbox4 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox4);
  gtk_object_set_data_full (GTK_OBJECT (window_dialog), "vbox4", vbox4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox4);
  gtk_container_add (GTK_CONTAINER (window_dialog), vbox4);

  frame3 = gtk_frame_new (NULL);
  gtk_widget_ref (frame3);
  gtk_object_set_data_full (GTK_OBJECT (window_dialog), "frame3", frame3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame3);
  gtk_box_pack_start (GTK_BOX (vbox4), frame3, TRUE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame3), 5);

  label_dialog_text = gtk_label_new ("...dialog text...");
  gtk_widget_ref (label_dialog_text);
  gtk_object_set_data_full (GTK_OBJECT (window_dialog), "label_dialog_text", label_dialog_text,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label_dialog_text);
  gtk_container_add (GTK_CONTAINER (frame3), label_dialog_text);
  gtk_misc_set_padding (GTK_MISC (label_dialog_text), 20, 20);

  hbox1 = gtk_hbox_new (TRUE, 0);
  gtk_widget_ref (hbox1);
  gtk_object_set_data_full (GTK_OBJECT (window_dialog), "hbox1", hbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox1);
  gtk_box_pack_start (GTK_BOX (vbox4), hbox1, FALSE, FALSE, 0);

  button_dialog_cancel = gtk_button_new_with_label ("CANCEL");
  gtk_widget_ref (button_dialog_cancel);
  gtk_object_set_data_full (GTK_OBJECT (window_dialog), "button_dialog_cancel", button_dialog_cancel,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button_dialog_cancel);
  gtk_box_pack_start (GTK_BOX (hbox1), button_dialog_cancel, FALSE, FALSE, 0);
  gtk_widget_set_usize (button_dialog_cancel, 60, -2);

  button_dialog_ok = gtk_button_new_with_label ("OK");
  gtk_widget_ref (button_dialog_ok);
  gtk_object_set_data_full (GTK_OBJECT (window_dialog), "button_dialog_ok", button_dialog_ok,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button_dialog_ok);
  gtk_box_pack_start (GTK_BOX (hbox1), button_dialog_ok, FALSE, FALSE, 0);
  gtk_widget_set_usize (button_dialog_ok, 60, -2);

  gtk_signal_connect (GTK_OBJECT (window_dialog), "delete_event",
                      GTK_SIGNAL_FUNC (gtk_widget_hide),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (button_dialog_cancel), "clicked",
                      GTK_SIGNAL_FUNC (on_button_dialog_cancel_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (button_dialog_ok), "clicked",
                      GTK_SIGNAL_FUNC (on_button_dialog_ok_clicked),
                      NULL);
