/*
 * md_arm_vfp.h - Machine-dependent definitions for ARM with a VFP.
 *
...
#ifndef	_ENGINE_MD_ARM_VFP_H
#define	_ENGINE_MD_ARM_VFP_H

#include "arm_vfp_codegen.h"
 ...
 */
#define	MD_FREG_0		(MD_FREG_MASK | ARM_D0)
#define	MD_FREG_1		(MD_FREG_MASK | ARM_D1)
#define	MD_FREG_2		(MD_FREG_MASK | ARM_D2)
#define	MD_FREG_3		(MD_FREG_MASK | ARM_D3)
#define	MD_FREG_4		(MD_FREG_MASK | ARM_D4)
#define	MD_FREG_5		(MD_FREG_MASK | ARM_D5)
#define	MD_FREG_6		(MD_FREG_MASK | ARM_D6)
#define	MD_FREG_7		(MD_FREG_MASK | ARM_D7)
#define	MD_FREG_8		(MD_FREG_MASK | ARM_D8)
#define	MD_FREG_9		(MD_FREG_MASK | ARM_D9)
#define	MD_FREG_10		(MD_FREG_MASK | ARM_D10)
#define	MD_FREG_11		(MD_FREG_MASK | ARM_D11)
#define	MD_FREG_12		(MD_FREG_MASK | ARM_D12)
#define	MD_FREG_13		(MD_FREG_MASK | ARM_D13)
#define	MD_FREG_14		(MD_FREG_MASK | ARM_D14)
#define	MD_FREG_15		-1
...
#define	md_load_const_float_32(inst,reg,mem)	\
			do { \
				...
				arm_vfp_FLDS((inst), (reg) & (~MD_FREG_MASK), (basereg), 0)  \
			while (0)
/*
...
#define	md_load_const_float_64(inst,reg,mem)	\
			do { \
				arm_mov_reg_imm((inst), ARM_WORK, (mem))  \
				arm_vfp_FLDD((inst), (reg) & (~MD_FREG_MASK), (basereg), (0))  \
			while (0)
...
#define	md_load_membase_float_32(inst,reg,basereg,offset)	\
			do { \
				arm_vfp_FLDS((inst), (reg) & (~MD_FREG_MASK), (basereg), (offset)) \
			} while (0)
#define	md_load_membase_float_64(inst,reg,basereg,offset)	\
			do {
				arm_vfp_FLDD((inst), (reg) & (~MD_FREG_MASK), (basereg), (offset)) \
			} while (0)
...
#define	md_store_membase_float_32(inst,reg,basereg,offset)	\
			do { \
				arm_vfp_FSTS((inst), (reg) & (~MD_FREG_MASK), (basereg), (offset))	\
			} while (0)
#define	md_store_membase_float_64(inst,reg,basereg,offset)	\
			do { \
				arm_vfp_FSTD((inst), (reg) & (~MD_FREG_MASK), (basereg), (offset))	\
			} while (0)
...
#define	md_reg_to_float_32(inst,reg)	\
			arm_vfp_FCVTSD((inst), (reg) & (~MD_FREG_MASK), (reg))
...
#define md_add_reg_reg_float(inst, reg1, reg2)	\
			arm_vfp_FADDD(inst, (reg2) & (~MD_FREG_MASK), \
			(reg1) & (~MD_FREG_MASK), (reg2) & (~MD_FREG_MASK))
			
#define md_sub_reg_reg_float(inst, reg1, reg2)	\
			arm_vfp_FSUBD(inst, (reg2) & (~MD_FREG_MASK), \
			(reg1) & (~MD_FREG_MASK), (reg2) & (~MD_FREG_MASK))


#define md_mul_reg_reg_float(inst, reg1, reg2)	\
			arm_vfp_FMULD(inst, (reg2) & (~MD_FREG_MASK), \
			(reg1) & (~MD_FREG_MASK), (reg2) & (~MD_FREG_MASK))


#define md_div_reg_reg_float(inst, reg1, reg2)	\
			arm_vfp_FDIVD(inst, (reg2) & (~MD_FREG_MASK), \
			(reg1) & (~MD_FREG_MASK), (reg2) & (~MD_FREG_MASK))

#define md_neg_reg_reg_float(inst, reg)	\
			arm_vfp_FADDD(inst, (reg) & (~MD_FREG_MASK), \
			(reg) & (~MD_FREG_MASK))
