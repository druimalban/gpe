...
BuildRequires:  treecc >= 0:0.3.6
BuildRequires:  pnet-interpreter >= 0:0.7.3
BuildRequires:  pnet-compiler >= 0:0.7.3
BuildRequires:  pnet-tools >= 0:0.7.3
BuildRequires:  XFree86-devel

Requires:       pnet-interpreter >= 0:0.7.3
Requires:       pnet-tools >= 0:0.7.3
