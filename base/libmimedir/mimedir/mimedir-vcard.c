...
mimedir_vcard_read_from_profile (MIMEDirVCard *vcard, MIMEDirProfile *profile, GError **error)
{
	...
	for (; attrs != NULL; attrs = g_slist_next (attrs)) {
		...
		/* Mailer (3.3.3) */
			...
			if (priv->mailer != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "MAILER");
				return FALSE;
			}
		...
		/* Time Zone (3.4.1) */
			...
			if (priv->timezone != G_MAXINT || priv->timezone_string != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "TZ");
				return FALSE;
			}
		...
		/* Job Title (3.5.1) */
			...
			if (priv->jobtitle != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "TITLE");
				return FALSE;
			}
		...
		/* Job Role (3.5.2) */
			...
			if (priv->jobrole != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "ROLE");
				return FALSE;
			}
		...
		/* Organization Logo (3.5.3) */
			...
			if (priv->logo || priv->logo_uri) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "LOGO");
				return FALSE;
			}
		...
		/* Agent (3.5.4) */
			...
			if (priv->agent || priv->agent_uri || priv->agent_string) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "AGENT");
				return FALSE;
			}
		...
		/* Organization (3.5.5) */
			...
			if (priv->organization != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "ORG");
				return FALSE;
			}
		...
		/* Note (3.6.2) */
			...
			if (priv->note != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "NOTE");
				return FALSE;
			}
		...
		/* Product ID (3.6.3) */
			...
			if (priv->prodid) {
				g_set_error (error, MIMEDIR_ATTRIBUTE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, name);
				return FALSE;
			}
		...
		/* Sort string (3.6.5) */
			...
			if (priv->sort_string != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "SORT-STRING");
				return FALSE;
			}
		...
		/* Sound (3.6.6) */
			...
			if (priv->sound || priv->sound_uri) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "SOUND");
				return FALSE;
			}
		...
		/* UID (3.6.7) */
			...
			if (priv->uid != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "UID");
				return FALSE;
			}
		...
		/* URL (3.6.8) */
			...
			if (priv->url != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "URL");
				return FALSE;
			}
		...
		/* Access Classification (3.7.1) */
			...
			if (priv->klass != NULL) {
				g_set_error (error, MIMEDIR_PROFILE_ERROR, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE, MIMEDIR_PROFILE_ERROR_DUPLICATE_ATTRIBUTE_STR, "CLASS");
				return FALSE;
			}
