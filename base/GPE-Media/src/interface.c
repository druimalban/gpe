...
create_GPE_Media (void)
{
  ...
  gtk_widget_set_name (GPE_Media, "GPE_Media");
  ...
  gtk_widget_set_name (normal1, "normal1");
  ...
  gtk_widget_set_name (repeat_1, "repeat_1");
  ...
  gtk_widget_set_name (repeat_all1, "repeat_all1");
  ...
  gtk_widget_set_name (shuffle1, "shuffle1");
  ...
  gtk_widget_set_name (AddList, "AddList");
  ...
  gtk_widget_set_name (DeleteList, "DeleteList");
  ...
  gtk_widget_set_name (VolScale, "VolScale");
  ...
  gtk_widget_set_name (BassScale, "BassScale");
  ...
  gtk_widget_set_name (TrebleScale, "TrebleScale");
  ...
  gtk_signal_connect (GTK_OBJECT (FileList), "click_column",
                      GTK_SIGNAL_FUNC (on_FileList_click_column),
                      NULL);
