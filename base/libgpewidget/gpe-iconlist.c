/* Generated by GOB (v2.0.3) on Mon Mar 24 01:01:17 2003
...
#line 94 "gpeiconlist.gob"
		...
		gtk_object_set_data (GTK_OBJECT (self), "vp", vp); //luc
...
#line 430 "gpeiconlist.gob"
	g_return_if_fail (GPE_IS_ICONLIST (self));
#line 877 "gpe-iconlist.c"
{
#line 431 "gpeiconlist.gob"
	
		int count;
    GtkAllocation * il_allocation; //iconlist's allocation
    GtkAllocation * vp_allocation; //viewport's allocation (does not include scrollbar)

    il_allocation = allocation; //NOT: &GTK_WIDGET(self)->allocation (!?!)
    vp_allocation = & (GTK_WIDGET(gtk_object_get_data (GTK_OBJECT(self), "vp"))->allocation);
    MAYBE_PRINTF("luc> _recalc il w h: %d %d\n", il_allocation->width, il_allocation->height);
    MAYBE_PRINTF("luc> _recalc vp w h: %d %d\n", vp_allocation->width, vp_allocation->height);

    //luc: I believe 15 was for the scrollbar's size
		//if (allocation->width > 15 + il_col_width (self)) 
		//	self->_priv->cols = (allocation->width - 15) / il_col_width (self);
		if (il_allocation->width > il_col_width (self)) //check according listicon's allocation
			self->_priv->cols = (il_allocation->width) / il_col_width (self);
		else
			self->_priv->cols = 1;
...
#line 478 "gpeiconlist.gob"
	g_return_if_fail (GPE_IS_ICONLIST (self));
#line 947 "gpe-iconlist.c"
{
#line 479 "gpeiconlist.gob"
...
#line 509 "gpeiconlist.gob"
	g_return_if_fail (GPE_IS_ICONLIST (self));
#line 1002 "gpe-iconlist.c"
{
#line 510 "gpeiconlist.gob"
...
#line 535 "gpeiconlist.gob"
	g_return_if_fail (GPE_IS_ICONLIST (self));
#line 1055 "gpe-iconlist.c"
{
#line 536 "gpeiconlist.gob"
...
#line 578 "gpeiconlist.gob"
	g_return_if_fail (GPE_IS_ICONLIST (self));
#line 1168 "gpe-iconlist.c"
{
#line 579 "gpeiconlist.gob"
...
#line 1258 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 636 "gpeiconlist.gob"
static struct ILIcon * 
...
#line 1280 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 648 "gpeiconlist.gob"
static void 
gpe_iconlist__cancel_popup (GPEIconList * il)
#line 1286 "gpe-iconlist.c"
{
