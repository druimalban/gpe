/* Generated by GOB (v2.0.3) on Wed Jan  1 14:37:57 2003
...
static void ___11_gpe_iconlist_size_allocate (GtkWidget * self, GtkAllocation * allocation) G_GNUC_UNUSED;
...
#define __GOB_FUNCTION__ "GPE:IconList::class_init"
	...
	if ___GOB_UNLIKELY(sizeof(gpointer ) != sizeof(gpointer )) {
		g_error("gpeiconlist.gob line 71: Type mismatch of \"clicked\" signal signature");
	}
	object_signals[SHOW_POPUP_SIGNAL] =
		g_signal_new ("show_popup",
			...
			G_TYPE_POINTER);
	if ___GOB_UNLIKELY(sizeof(gpointer ) != sizeof(gpointer )) {
		g_error("gpeiconlist.gob line 74: Type mismatch of \"show_popup\" signal signature");
	}

	c->clicked = NULL;
	c->show_popup = NULL;
#line 489 "gpeiconlist.gob"
	gtk_widget_class->size_allocate = ___11_gpe_iconlist_size_allocate;
...
#line 474 "gpe-iconlist.c"
{
#define __GOB_FUNCTION__ "GPE:IconList::new"
{
#line 113 "gpeiconlist.gob"
...
#line 810 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 402 "gpeiconlist.gob"
static void 
gpe_iconlist__recalc_size (GPEIconList * self, GtkAllocation * allocation)
#line 816 "gpe-iconlist.c"
{
...
{
#line 449 "gpeiconlist.gob"
	
		self->_priv->flag_embolden = yes;
	}}
#line 926 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 453 "gpeiconlist.gob"
void 
...
#line 990 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 489 "gpeiconlist.gob"
static void 
___11_gpe_iconlist_size_allocate (GtkWidget * self, GtkAllocation * allocation)
...
#line 571 "gpeiconlist.gob"
		...
		/* I'd like to run this after the popup menu pops back down, but
		   I can't seem to :( */
		gpe_iconlist_popup_removed (il);

		gpe_iconlist_show_popup(il, gpe_iconlist__get_icon(il,col, row)->udata);

		return FALSE;
	}}
#line 1156 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 584 "gpeiconlist.gob"
void 
gpe_iconlist_popup_removed (GPEIconList * self)
#line 1162 "gpe-iconlist.c"
{
