/* Generated by GOB (v2.0.2) on Thu Nov 14 13:24:01 2002
...
#line 44 "gpeiconlist.gob"
	int mrow;
#line 45 "gpeiconlist.gob"
	int popup_timeout;
#line 78 "gpe-iconlist.c"
};
...
static void ___a_gpe_iconlist_size_allocate (GtkWidget * self, GtkAllocation * allocation) G_GNUC_UNUSED;
...
#define __GOB_FUNCTION__ "GPE:IconList::class_init"
	...
	if(sizeof(gpointer ) != sizeof(gpointer )) {
		g_error("gpeiconlist.gob line 48: Type mismatch of \"clicked\" signal signature");
	}
	object_signals[SHOW_POPUP_SIGNAL] =
		g_signal_new ("show_popup",
			...
			G_TYPE_POINTER);
	if(sizeof(gpointer ) != sizeof(gpointer )) {
		g_error("gpeiconlist.gob line 51: Type mismatch of \"show_popup\" signal signature");
	}

	c->clicked = NULL;
	c->show_popup = NULL;
#line 354 "gpeiconlist.gob"
	gtk_widget_class->size_allocate = ___a_gpe_iconlist_size_allocate;
#line 278 "gpe-iconlist.c"
...
#line 3 "gpeiconlist.gob"
	self->_priv->rows = 1;
#line 300 "gpe-iconlist.c"
#line 3 "gpeiconlist.gob"
	self->_priv->cols = 1;
#line 303 "gpe-iconlist.c"
#line 3 "gpeiconlist.gob"
	self->_priv->mcol = -1;
#line 306 "gpe-iconlist.c"
#line 3 "gpeiconlist.gob"
	self->_priv->mrow = -1;
#line 309 "gpe-iconlist.c"
#line 3 "gpeiconlist.gob"
	self->_priv->popup_timeout = 0;
#line 312 "gpe-iconlist.c"
 {
...
#line 349 "gpeiconlist.gob"
	g_return_if_fail (GPE_IS_ICONLIST (self));
#line 724 "gpe-iconlist.c"
{
#line 350 "gpeiconlist.gob"
	
		self->_priv->icons = g_list_append (self->_priv->icons, gpe_iconlist_new_icon (title, icon, udata));
	}}
#line 730 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 354 "gpeiconlist.gob"
static void 
___a_gpe_iconlist_size_allocate (GtkWidget * self, GtkAllocation * allocation)
#line 736 "gpe-iconlist.c"
...
#line 798 "gpe-iconlist.c"
#undef __GOB_FUNCTION__

#line 401 "gpeiconlist.gob"
static void 
gpe_iconlist__refresh_containing (GtkWidget * widget, int col, int row)
#line 804 "gpe-iconlist.c"
{
...
#line 432 "gpeiconlist.gob"
		...
		if (col == il->_priv->mcol && row == il->_priv->mrow)
			gpe_iconlist_clicked (il,
					      (gpe_iconlist__get_icon(il,
								      il->_priv->mcol,
								      il->_priv->mrow))->udata);		
