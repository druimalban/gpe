/* Generated by GOB (v2.0.2) on Tue Nov 12 19:08:04 2002
...
#line 403 "gpeiconlist.gob"
		...
		if (col == il->_priv->mcol && row == il->_priv->mrow) {
			...
			icons = il->_priv->icons;
			for (i=0;i<il->_priv->mrow*il->_priv->cols+il->_priv->mcol && icons;i++)
				icons = icons->next;
