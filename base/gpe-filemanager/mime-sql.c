...
add_mime_types (void)
{
  ...
  e = new_mime_type ("image/jpeg", "JPEG Image File", "jpeg", "qiv", "image-jpeg");
  e = new_mime_type ("image/jpeg", "JPEG Image File", "jpg", "qiv", "image-jpeg");
  e = new_mime_type ("image/jpeg", "JPEG Image File", "jpe", "qiv", "image-jpeg");
  e = new_mime_type ("image/png", "Portabe Image Graphics File", "png", "qiv", "image-png");
  e = new_mime_type ("image/gif", "GIF Image File", "gif", "qiv", "image-gif");
  e = new_mime_type ("image/xpm", "XPM Image File", "xpm", "qiv", "image-xpm");
